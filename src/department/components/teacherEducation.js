...
const TeacherEducation = () => {
    ...
    const departmentNames = [
        {
            id: 1,
            title: 'EDUCATION PROGRAM FOR ELEMENTARY TEACHER EDUCATION',
            description: '',
        },
        {
            id: 2,
            title: 'EDUCATION PROGRAM FOR SECONDARY TEACHER EDUCATION',
            description: '',
        },
        {
            id: 3,
            title: 'THE PROGRAM FOR PROMOTING SPECIALTIES OF PROMINENT TEACHER-TO-BE OF NDHU',
            description: '',
        },
        {
            id: 4,
            title: 'COURSE OF BILLINGUAL TEACHER EDUCATION',
            description: '',
        },
    ];
